        ...
        public static List<Solucion> SBX(List<Solucion> padres)
        {
            ...
            { //Por cada conjunto de padres
                ...
                for (int j = 0; j < totalVariables; j++)
                {
                    ...
                    { //Prob de variación en los genes
                        ...
                        { //Los genes son heredados sin variacion
                    ...
                    {
                        varDecisionHijo1[j] = ReparadorValorSolucion.repararValor(varDecisionPadre2[j], limInferior, limSuperior);
                        varDecisionHijo2[j] = ReparadorValorSolucion.repararValor(varDecisionPadre1[j], limInferior, limSuperior);
                    }
                }
